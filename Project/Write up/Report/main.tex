...
\hline
Task  & \begin{tabular}[c]{@{}c@{}}Count-Based\\ Baseline\end{tabular} & \begin{tabular}[c]{@{}c@{}}3-hop MemNN\\ RNN-Like\\ TE  + PE\\ (join train)\end{tabular} & \begin{tabular}[c]{@{}c@{}}1-hop MemNN\\ Adjacent\\ TE\\ (join train)\end{tabular} & \begin{tabular}[c]{@{}c@{}}2-hop MemNN\\ Adjacent\\ TE\\ (join train)\end{tabular} & \begin{tabular}[c]{@{}c@{}}3-hop MemNN\\ Adjacent\\ TE\\ (join train)\end{tabular} & \begin{tabular}[c]{@{}c@{}}3-hop MemNN\\ Adjacent\\ TE+PE\\ (join train)\end{tabular} \\ \hline
1     & 0.5                                                            & 0.99                                                                                     & 1                                                                                  & 0.97                                                                               & 0.99                                                                               &                                                                                       \\ \cline{1-1}
2     & 0.4                                                            & 0.79                                                                                     & 0.24                                                                               & 0.25                                                                               & 0.37                                                                               &                                                                                       \\ \cline{1-1}
