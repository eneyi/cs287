...
--          EXPERIMENTAL WORK
--
-- This is an experimental batch version of the model
-- Not functional right now, this is particularly tricky
-- because we manipulate 3d tensors so the natural way 
-- for batching of nn does not work
